...
#if false // Directive to allow file to stop compiling in Unity- for debugging purposes
...
public class Triple_axis_V2 : MonoBehaviour
{
    ...
    public int[] yAxis = { 0, 1 }, xAxis = { 2, 3 }, zAxis = { 4, 5 };
                    ...
                    else if (gesture == "x point" || gesture == "y point" || gesture == "z point")
                    {
                        ...
                        else
                        {
                            ...
                            if (!toggleHaptics && gesture == "z_point")
                            {
                                try
                                {
                                    asar.SendMessage(xAxis[i], (int)sent_data[2]);
                                    print("In z point");
                                }
                                catch (Exception e)
                                {
