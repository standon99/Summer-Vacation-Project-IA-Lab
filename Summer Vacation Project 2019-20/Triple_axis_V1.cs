    ...
    int[] serial_Read()
    {
        ...
        if (string_len > 2)
        {
            ...
            if (setter == 1)
            {
                ...
                sentRotaryVals = new int[ind];
                sentRotaryValsHist = new int[ind];
                for (int b = 0; b < ind; b++)
                {
                    sentRotaryVals[b] = 0;
                    sentRotaryValsHist[b] = 0;
                }
                sentButtonVals = new int[ind];
            ...
            for (int u = 0; u < (string_len); u=u+3)
            {
                sentPositions[cntr] = Int32.Parse(numbers[u]);
                print("POS VAL");
                print(sentPositions[cntr]);
                cntr++;
            }

            cntr = 0;
            for (int m = 1; m < (string_len); m=m+3)
            {
            ...
            cntr = 0;
            for (int n = 2; n < (string_len); n=n+3)
            {
