...
namespace VolumeRendering
{
    ...
    public class VolumeRenderingController : MonoBehaviour {
        ...
        void Update()
        {
            ...
            volume.sliceXMin = 1f - t.x0 / 1023.0f;
            volume.sliceXMax = 1f - t.x1 / 1023.0f;
            volume.sliceYMin = t.y0 / 1023.0f;
            volume.sliceYMax = t.y1 / 1023.0f;
            volume.sliceZMin = t.z0 / 1023.0f;
            volume.sliceZMax = t.z1 / 1023.0f;
